			...
			<article>			
				...
				<%
					...
					try {
						...
						String sqlCount = "SELECT COUNT(*) FROM QNA_BOARD";
						...
						String sqlList = "SELECT NUM, USERNAME, TITLE, TIME, HIT, INDENT from QNA_BOARD order by REF DESC, STEP ASC";
				...
				%>
						...
						<a href="qna_view.jsp?idx=<%=idx%>"><%=title%></a>
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					...
					<tr align="center">
						<td><input type=button value="글쓰기" OnClick="window.location='qna_write.jsp'"></td>
					</tr>
				</table>
			</article>
		</section>
