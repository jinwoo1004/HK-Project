...
<%
	...
	try {
		...
		String sql = "SELECT USERNAME, TITLE, MEMO, TIME, HIT FROM QNA_BOARD WHERE NUM=" + idx;
					...
					<tr>
						<td>
							...
							<table width="413">
								...
								<%
									sql = "UPDATE QNA_BOARD SET HIT=" + hit + " where NUM=" + idx;
								...
								<tr align="center">
									...
									<td colspan="2" width="399">
										<input type=button value="글쓰기" OnClick="window.location='qna_write.jsp'">
										<input type=button value="답글" OnClick="window.location='qna_reply.jsp?idx=<%=idx%>'">
										<input type=button value="목록" OnClick="window.location='qna_list.jsp'">
										<input type=button value="수정" OnClick="window.location='qna_modify.jsp?idx=<%=idx%>'">
										<input type=button value="삭제" OnClick="window.location='qna_delete.jsp?idx=<%=idx%>'">
									</td>
								</tr>
							</table>
						</td>
